...
public class ServerControl {
    ...
    synchronized UserDescription
            addUser(JsonElement description) throws UnrecoverableKeyException, GeneralSecurityException {
        int id;
        String path = null;
        ...
        try {
            ...
            //cria as chaves e tudo necessário a um novo user na pasta KeyPair
            GenerateKeys.create(description.getAsJsonObject().get("uuid").toString(),id);
            users.add(user);
    ...
    String sendMessage(int src, int dst, String msg, String receipt) {
        ...
        try {
            ...
            System.out.println("path: " + path + "source: " + src + "_");
            saveOnFile(path + src + "_" + nr, msg);
            System.out.println("path+src_+nr: " + path + src + "_" + nr);
            result = "[\"" + src + "_" + nr + "\"";
